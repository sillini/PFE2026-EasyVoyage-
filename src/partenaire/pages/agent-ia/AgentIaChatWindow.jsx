// ══════════════════════════════════════════════════════════
//  src/partenaire/pages/agent-ia/AgentIaChatWindow.jsx
//  Zone principale du chat (messages + composer) — Espace Partenaire
// ══════════════════════════════════════════════════════════
...
/* ── Formatage markdown leger : gras + liens + retours ligne ── */
...
/* ── Suggestions d'accueil (cartes de demarrage) — adaptees au PARTENAIRE ── */
const STARTER_PROMPTS = [
  {
    icon: "📊",
    title: "Tableau de bord",
    text: "Donne-moi un résumé de mes revenus ce mois",
  },
  {
    icon: "🏨",
    title: "Mes hôtels",
    text: "Quel est mon hôtel le mieux noté ?",
  },
  {
    icon: "💰",
    title: "Finances",
    text: "Combien j'ai reçu de paiements ce mois ?",
  },
  {
    icon: "🎯",
    title: "Promotions",
    text: "Quelles sont mes promotions actives ?",
  },
];
...
export default function AgentIaChatWindow({
  ...
  return (
    <section className="aia-chat">
      {/* Header — sans badge "Connecte" */}
      <div className="aia-chat-header">
        <div className="aia-chat-header-left">
          <div className="aia-chat-avatar">🤖</div>
          <div>
            <h2>Agent IA</h2>
            <span className="aia-chat-subtitle">Votre assistant intelligent partenaire</span>
          </div>
        </div>
      </div>
      ...
      <div className="aia-chat-messages">
        ...
        {!loadingConv && isEmpty && (
          <div className="aia-chat-welcome">
            ...
            <p>
              Posez une question sur votre activité — hôtels, chambres, réservations,
              finances, promotions, support…
            </p>
      ...
      <div className="aia-chat-composer">
        ...
        <div className="aia-chat-footer-hint">
          L'Agent IA peut commettre des erreurs — vérifiez les informations importantes.
        </div>
      </div>
    </section>
  );
